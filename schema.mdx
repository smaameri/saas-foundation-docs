...
SaaS Foundation uses Prisma with PostgreSQL. The schema combines Better Auth
models with the organization, invitation, and API key models used by the admin
