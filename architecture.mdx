...
<CardGroup cols={3}>
  ...
  <Card title="Repositories and tenancy" icon="database" href="/architecture-repositories">
    Keep Prisma access behind entity repositories and preserve portal trust
    boundaries.
  </Card>
  <Card title="Validation and serialization" icon="code-compare" href="/architecture-contracts">
    Share validation where useful and make every frontend data shape explicit.
  </Card>
</CardGroup>
